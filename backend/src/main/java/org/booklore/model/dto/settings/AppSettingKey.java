...
public enum AppSettingKey {
    ...
    OIDC_SESSION_DURATION_HOURS         ("oidc_session_duration_hours",          false, true,  List.of(PermissionType.ADMIN)),
    OIDC_GROUP_SYNC_MODE                ("oidc_group_sync_mode",                 false, true,  List.of(PermissionType.ADMIN)),
    ...
    METADATA_DOWNLOAD_ON_BOOKDROP       ("metadata_download_on_bookdrop",        false, true,  List.of(PermissionType.ADMIN, PermissionType.MANAGE_METADATA_CONFIG)),
    METADATA_PROVIDER_SPECIFIC_FIELDS   ("metadata_provider_specific_fields",    true,  true, List.of(PermissionType.ADMIN, PermissionType.MANAGE_METADATA_CONFIG)),
    QUICK_BOOK_MATCH                    ("quick_book_match",                     true,  true, List.of(PermissionType.ADMIN, PermissionType.MANAGE_METADATA_CONFIG)),
    UPLOAD_FILE_PATTERN                 ("upload_file_pattern",                  false, true,  List.of(PermissionType.ADMIN, PermissionType.MANAGE_METADATA_CONFIG)),
    MOVE_FILE_PATTERN                   ("move_file_pattern",                    false, true,  List.of(PermissionType.ADMIN, PermissionType.MANAGE_METADATA_CONFIG)),

    // ADMIN + MANAGE_GLOBAL_PREFERENCES
    COVER_CROPPING_SETTINGS             ("cover_cropping_settings",              true,  true,  List.of(PermissionType.ADMIN, PermissionType.MANAGE_GLOBAL_PREFERENCES)),
    AUTO_BOOK_SEARCH                    ("auto_book_search",                     false, true,  List.of(PermissionType.ADMIN, PermissionType.MANAGE_GLOBAL_PREFERENCES)),
    SIMILAR_BOOK_RECOMMENDATION         ("similar_book_recommendation",          false, true,  List.of(PermissionType.ADMIN, PermissionType.MANAGE_GLOBAL_PREFERENCES)),
    PDF_CACHE_SIZE_IN_MB                ("pdf_cache_size_in_mb",                 false, true,  List.of(PermissionType.ADMIN, PermissionType.MANAGE_GLOBAL_PREFERENCES)),
    MAX_FILE_UPLOAD_SIZE_IN_MB          ("max_file_upload_size_in_mb",           false, true,  List.of(PermissionType.ADMIN, PermissionType.MANAGE_GLOBAL_PREFERENCES)),

    // No specific permissions required
    SIDEBAR_LIBRARY_SORTING             ("sidebar_library_sorting",              true,  true,  List.of()),
    SIDEBAR_SHELF_SORTING               ("sidebar_shelf_sorting",                true,  true,  List.of());
    // @formatter:on
