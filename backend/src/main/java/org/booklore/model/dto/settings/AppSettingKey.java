...
public enum AppSettingKey {
    ...
    AUTO_CONVERT_ENABLED                ("auto_convert_enabled",                 false, false, List.of(PermissionType.ADMIN, PermissionType.MANAGE_GLOBAL_PREFERENCES)),
    AUTO_CONVERT_FORMATS                ("auto_convert_formats",                 false, false, List.of(PermissionType.ADMIN, PermissionType.MANAGE_GLOBAL_PREFERENCES)),
